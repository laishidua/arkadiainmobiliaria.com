...
$dazz_cs_seo_desc          = stripslashes(sanitize_text_field($_POST['dazz_cs_seo_desc']));
$dazz_cs_seo_analytics          = stripslashes(sanitize_text_field($_POST['dazz_cs_seo_analytics']));
